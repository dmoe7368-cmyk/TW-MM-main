        ...
        <div class="modal-overlay" id="reg-overlay" onclick="window.closeRegisterModal()">
            ...
            <div style="width:40px;height:4px;background:rgba(255,255,255,0.15);border-radius:4px;margin:0 auto 20px;"></div>
                ...
                <div style="text-align:center; margin-bottom:20px;">
                    <div style="width:56px; height:56px; border-radius:16px; background:${isGold ? 'rgba(196,160,255,0.1)' : 'rgba(80,190,255,0.1)'}; border:1.5px solid ${cfg.color}44; display:flex; align-items:center; justify-content:center; margin:0 auto 12px;">
                ...
                <div style="background:#000; border-radius:12px; padding:16px; margin-bottom:16px;">
                    ...
                    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom:10px; padding-bottom:10px; border-bottom:1px solid var(--border);">
                        ...
                        <span style="font-family:'Rajdhani',sans-serif; font-weight:700; font-size:1.1rem; color:${canAfford ? '#7dd8ff' : '#f87171'};">${coins} 🪙 <span style="font-size:0.75rem; color:var(--dim);">· ${(coins*100).toLocaleString()} ကျပ်</span></span>
                    </div>
                ...
                <div style="background:rgba(80,190,255,0.06); border:1px solid rgba(80,190,255,0.15); border-radius:10px; padding:12px; margin-bottom:16px; display:flex; justify-content:space-between; align-items:center;">
                ...
                <div style="background:rgba(255,77,77,0.06); border:1px solid rgba(255,77,77,0.2); border-radius:10px; padding:14px; margin-bottom:16px;">
                    ...
                    <div style="display:flex; gap:8px;">
                        <a href="${window.TW_CONTACTS?.facebook || 'https://m.me/'}" target="_blank" style="
                        ...
                        <a href="${window.TW_CONTACTS?.telegram || 'https://t.me/'}" target="_blank" style="
                            flex:1; display:flex; align-items:center; justify-content:center; gap:7px;
