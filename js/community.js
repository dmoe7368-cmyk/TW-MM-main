    ...
    main.innerHTML = `
            ...
            <div id="comm-header"
                ...
                <div style="flex:1;min-width:0;">
                    ...
                    <div style="font-family:'Rajdhani',sans-serif;font-size:0.7rem;
                                 color:#555;font-weight:600;">Community Chat</div>
                </div>
                <div style="display:flex;align-items:center;gap:5px;flex-shrink:0;">
                    <span style="width:7px;height:7px;background:var(--green);
                    ...
                    <span style="font-family:'Rajdhani',sans-serif;font-size:0.72rem;
                                  color:var(--green);font-weight:800;letter-spacing:1px;">LIVE</span>
                </div>
            </div>
                ...
                <div style="display:flex;align-items:flex-end;gap:8px;">
                    ...
                    <textarea id="postInput" rows="1"
                        style="flex:1;background:#1a1a1a;color:var(--text);
                               border:1px solid #333;padding:9px 14px;
        ...
        <div id="reaction-picker"
             style="display:none;position:fixed;z-index:5000;background:#1e1e1e;
                    border:1px solid #333;border-radius:14px;padding:10px 14px;
          ...
          list.innerHTML = snapshot.docs.map(doc => {
              ...
              const reactionHtml = EMOJIS.map(e => {
                  ...
                  return `<span onclick="toggleReaction('${docId}','${e}')"
                      style="background:${mine?'rgba(0,255,136,0.15)':'#1e1e1e'};
                             border:1px solid ${mine?'rgba(0,255,136,0.4)':'#2a2a2a'};
              ...
              const replyHtml = p.replyToName ? `
                  <div style="border-left:3px solid rgba(0,255,136,0.4);padding:4px 10px;
                  ...
                  <div style="display:flex;align-items:center;gap:5px;flex-wrap:wrap;
                      ...
                      <button onclick="showReactionPicker('${docId}',event)"
                          style="background:#1a1a1a;border:1px solid #2a2a2a;
                                 ...
                                 font-size:0.75rem;color:#555;line-height:1.6;">+ 😊</button>
              ...
              if (isMe) {
                  ...
                  <div id="post-${docId}"
                      ...
                      <div style="font-family:'Rajdhani',sans-serif;font-size:0.65rem;
                                   color:#3a3a3a;margin-right:4px;">${time}</div>
                  ...
                  <div id="post-${docId}" style="display:flex;align-items:flex-start;gap:8px;">
                      <div style="width:30px;height:30px;border-radius:50%;flex-shrink:0;
                                   ...
                                   display:flex;align-items:center;justify-content:center;
                                   font-family:'Rajdhani',sans-serif;font-weight:900;
                                   font-size:0.82rem;color:var(--green);">${init}</div>
                      <div style="max-width:80%;">
                          <div style="font-family:'Rajdhani',sans-serif;font-size:0.7rem;
                                       color:var(--green);font-weight:800;margin-bottom:3px;">
                              ${escHtml(p.name)}
                              <span style="color:#3a3a3a;font-weight:600;">· ${time}</span>
                          </div>
                          ${replyHtml}
                          <div style="background:#1a1a1a;color:var(--text);padding:10px 14px;
